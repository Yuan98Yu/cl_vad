...
from clvad.classifier.data.base_dataset import BaseADDataset
from clvad.classifier.model.base_model import BaseModel
...
class BaseTrainer(ABC):
    ...
    @abstractmethod
    def train(self, dataset: BaseADDataset, net: BaseModel) -> BaseModel:
        """
